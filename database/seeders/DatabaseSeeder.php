...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            ['usr_id' => 3, 'usr_name' => 'admin', 'usr_email' => 'admin@gmail.com', 'usr_password' => Hash::make('11111111'), 'usr_role' => 'student_affairs'],
            ['usr_id' => 4, 'usr_name' => 'uno', 'usr_email' => 'uno@gmail.com', 'usr_password' => Hash::make('11111111'), 'usr_role' => 'student_affairs'],
            ['usr_id' => 5, 'usr_name' => 'Asnan', 'usr_email' => 'asnan@gmail.com', 'usr_password' => Hash::make('11111111'), 'usr_role' => 'student'],
        ]);
